...
with open("lista_taskuri.txt", "a") as fisier:
    while True:
        ...
        with open("lista_taskuri.txt", "r+") as dubluri:
            if task in dubluri.read():
...
print(f"Meniu:\n"
      f"1.Listare date: realizare de sortare în funcție de categorie.\n"
      f"2.Sortare\n"
      f"0.Iesire din program")
alegere = int(input("Alege o optiune din meniu: "))
