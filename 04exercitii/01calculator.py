...
# verficam daca ceea ce introduce utilizatorul este in intervalul 0-9 sau contine .
...
if stare_conversie is True:
    ...
    if stare_conversie is True:
        ...
        # daca operatia introdusa de la tastatura se afla in strigul cautat
        if len(operatie) == 1 and operatie in "+-*/":
            ...
            # daca operatie e / atunci realizam impartire
            if operatie == "+":
